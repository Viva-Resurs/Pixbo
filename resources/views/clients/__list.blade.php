        ...
        <tr>
            ...
            <td class="actions">
                ...
                {!! Form::open(['method' => 'DELETE', 'route' => ['clients.destroy', $client->id], 'style' => 'display:inline']) !!}
                    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#confirmDelete" data-title="Delete Client" data-message="Are you sure you want to delete this client ?">
