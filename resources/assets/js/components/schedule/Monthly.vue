    ...
    <div class="form-group">
        <div class="form-group">
            <label for="inputFrequency" class="control-label">
                ...
                <span class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="{{ trans('messages.event_frequency_month_tooltip') }}"></span>
            </label>
    ...
    <div class="form-group">
        <div class="form-group">
            <label for="inputRecur_day_num">
                {{ trans('schedule.week') }}
                <span class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="{{ trans('messages.event_week_tooltip') }}"></span>
            </label>
    ...
    <div class="form-group">
        <div class="form-group">
            <label for="inputRecur_day">
                {{ 'messages.day' }}
                <span class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="{{ trans('messages.event_day_tooltip') }}"></span>
            </label>
