export const recur_options = [
    {id: 'none',    name:   'schedule.never'},
    {id: 'daily',   name:   'schedule.daily'},
    {id: 'weekly',  name:   'schedule.weekly'},
    {id: 'monthly', name:   'schedule.monthly'},
    {id: 'yearly',  name:   'schedule.yearly'}
];
...
export const frequency_options1 = [
    {id: 1, name: 'schedule.every1'},
    {id: 2, name: 'schedule.every_two1'},
    {id: 3, name: 'schedule.every_three1'},
    {id: 4, name: 'schedule.every_four1'},
    {id: 5, name: 'schedule.every_five1'},
]
...
export const weekdays1 = [
    {name:'schedule.monday1',id:1},
    {name:'schedule.tuesday1',id:2},
    {name:'schedule.wednesday1',id:3},
    {name:'schedule.thursday1',id:4},
    {name:'schedule.friday1',id:5},
    {name:'schedule.saturday1',id:6},
    {name:'schedule.sunday1',id:0}
]

export const weekday_abbr = [
    {name: 'schedule.monday_short', id: 1},
    {name: 'schedule.tuesday_short', id: 2},
    {name: 'schedule.wednesday_short', id: 3},
    {name: 'schedule.thursday_short', id: 4},
    {name: 'schedule.friday_short', id: 5},
    {name: 'schedule.saturday_short', id: 6},
    {name: 'schedule.sunday_short', id: 0},
]

export const days_before = [
    {id: 0, name: 'schedule.zero', plural: 1 },
    {id: 1, name: 'schedule.one', plural: 1 },
